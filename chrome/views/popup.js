...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("productRegisterButton").style.display = "none"; // 상품 등록 버튼 숨김
  ...
  function displayCrawledData(data) {
    ...
    editButton.textContent = '상품 정보 수정';
    editButton.style.marginBottom = '10px';
    
    editButton.addEventListener('click', () => {
        // formattedData를 storage에 저장
        chrome.storage.local.set({ formattedData: formattedData }, () => {
    ...
    // Register 버튼 숨기기
    productRegisterButton.parentNode.insertBefore(editButton, productRegisterButton);
  }
